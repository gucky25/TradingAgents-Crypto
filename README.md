...
# TradingAgents Crypto: Multi-Agent Crypto Analysis Tool

This fork adapts TradingAgents into a crypto-first analysis tool. It keeps the multi-agent research, debate, trader, risk, and portfolio-manager workflow, but defaults the project toward 24/7 crypto instruments such as `BTC-USD` and `ETH-USD`.

It is a research and signal-generation tool. It does not place live exchange orders.
...
See [docs/CRYPTO_USAGE.md](docs/CRYPTO_USAGE.md) for the full crypto usage guide.
